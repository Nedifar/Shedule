...
namespace AgendaApp.Pages
{
    ...
    public partial class TabbedPag : Xamarin.Forms.TabbedPage
    {
        ...
        async void version()
        {
            ...
            string vars = web.DownloadString("https://bsite.net/GrishaMasha/i/updateMobile/mobileVersion.txt");
            string link;
            if(vars != currentVersion)
            {
                ...
                if (b)
                {
                    //link = web.DownloadString("https://bsite.net/GrishaMasha/i/updateMobile/mobileLink.txt");
        ...
        async void Sign()
        {
            ...
            catch
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    var resulti = await client.GetAsync($"https://bsite.net/GrishaMasha/i/api/lastdance/getSignData/{result}");
