...
namespace AgendaApp.Pages
{
    ...
    public partial class TabbedPag : Xamarin.Forms.TabbedPage
    {
        ...
        async void version()
        {
            ...
            string vars = web.DownloadString("http://drankmin-001-site1.htempurl.com/updateMobile/mobileVersion.txt");
            string link;
            if(vars != currentVersion)
            {
                ...
                if (b)
                {
                    //link = web.DownloadString("http://drankmin-001-site1.htempurl.com/updateMobile/mobileLink.txt");
        ...
        async void Sign()
        {
            ...
            catch
            {
                using (HttpClient client = new HttpClient())
                {
                    ...
                    var resulti = await client.GetAsync($"http://drankmin-001-site1.htempurl.com/api/lastdance/getSignData/{result}");
